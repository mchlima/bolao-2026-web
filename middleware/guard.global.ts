...
const PUBLIC_EXACT = new Set(['/', '/entrar', '/cadastro', '/como-funciona', '/bolao-da-copa-do-mundo-2026', '/bolao-do-brasileirao', '/bolao-da-libertadores', '/bolao-da-copa-do-brasil', '/bolao-da-sudamericana', '/bolao-do-brasileirao-serie-b', '/copa-do-mundo-2026']);
