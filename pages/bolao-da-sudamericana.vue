...
// Landing de SEO+GEO mirando "bolão da sudamericana" (+ variações). A edição 2026
// está no mata-mata (playoffs → oitavas em diante). Pública (ver guard.global.ts).
// Dados já no banco (seed-copa-sudamericana).
definePageMeta({ layout: 'default' });

const auth = useAuthStore();
const siteUrl = String(useRuntimeConfig().public.siteUrl);
const url = `${siteUrl}/bolao-da-sudamericana`;
const authLink = useAuthLink();

const title = 'Bolão da Sudamericana 2026 grátis — palpite no mata-mata | Cravei';
const desc =
  'Faça seu bolão da Copa Sudamericana 2026 grátis com os amigos: palpite nos jogos do mata-mata da CONMEBOL Sudamericana — playoffs, oitavas, quartas, semis e final — pontue pela precisão do placar e acompanhe o ranking ao vivo a cada gol. Sem instalar app.';

// FAQ específico da Sudamericana (texto visível + FAQPage schema). Respostas curtas
// e autocontidas — formato que tanto o Google quanto as IAs citam (GEO).
const FAQ: FaqQA[] = [
  {
    q: 'O que é o bolão da Sudamericana 2026?',
    a: 'O bolão da Sudamericana 2026 é uma disputa entre amigos em que cada um palpita os placares dos jogos da CONMEBOL Sudamericana e ganha pontos pela precisão dos acertos. No Cravei você cria um bolão privado grátis, convida a turma e vê o ranking se mexer ao vivo a cada gol do mata-mata.',
  },
  {
    q: 'O bolão da Copa Sudamericana é grátis?',
    a: 'Sim. Criar conta, montar bolões e palpitar nos jogos da Sudamericana é totalmente grátis no Cravei, direto no navegador e sem precisar instalar aplicativo.',
  },
  {
    q: 'Quando é o mata-mata da Sudamericana 2026?',
    a: 'Os playoffs do mata-mata são em julho de 2026, em jogos de ida e volta, e o mata-mata segue com oitavas, quartas, semifinais e a grande final em jogo único. No Cravei você já pode montar o bolão e cravar os placares de cada confronto.',
  },
  {
    q: 'Como criar um bolão da Sudamericana com os amigos?',
    a: 'Crie sua conta grátis, monte um bolão privado da Sudamericana e compartilhe o link de convite com a galera. Cada pessoa entra, palpita os jogos do mata-mata e disputa o ranking.',
  },
  {
  ...
  meta: [
    {
      name: 'keywords',
      content:
        'bolão da sudamericana, bolão da copa sudamericana, bolão sudamericana 2026, palpites da sudamericana, bolão do mata-mata, bolão online grátis, bolão entre amigos, ranking ao vivo, bolão de futebol',
    },
  ],
  script: [
    { key: 'ld-faq', type: 'application/ld+json', innerHTML: JSON.stringify(faqJsonLd(FAQ)) },
    {
      ...
      innerHTML: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Bolão da Sudamericana 2026', item: url },
        ],
      }),
    },
  ],
...
// Faixa de números da Sudamericana 2026 (mata-mata) — chamativo + fatos (sinal GEO).
const stats = [
  { n: '8', l: 'confrontos nos playoffs' },
  { n: '16', l: 'times no mata-mata' },
  { n: 'R$ 0', l: 'pra jogar, sempre' },
];

const steps = [
  { n: 1, t: 'Crie seu bolão', d: 'Faça sua conta grátis e monte um bolão privado da Sudamericana 2026 em menos de um minuto.', c: 'var(--emerald)' },
...
const reasons = [
  ...
  { i: 'refresh', c: 'var(--azure)', t: 'Placar automático', d: 'Os resultados dos jogos da Sudamericana entram sozinhos — você só palpita.' },
...
<template>
  <main class="lp container">
    <nav class="crumbs">
      ...
      <span>›</span>
      <span>Bolão da Sudamericana 2026</span>
    </nav>
    ...
    <header class="hero">
      ...
      <div class="hero-grid">
        <div class="hero-text">
          <span class="eyebrow"><span class="eb-dot" />CONMEBOL Sudamericana · Mata-mata 2026</span>
          <h1>Bolão da <span class="hl">Sudamericana 2026</span></h1>
          <p class="lead">
            Crie seu <strong>bolão da Copa Sudamericana 2026</strong> grátis e dispute com os amigos:
            palpite nos jogos do <strong>mata-mata</strong> — playoffs, oitavas, quartas, semis e a
            final —, pontue pela precisão do placar e veja o ranking se mexer <b>ao vivo</b> a cada
            gol. Sem instalar app, direto no navegador.
          </p>
          <div class="cta">
    ...
    <section class="sec intro">
      <h2>O que é o bolão da Sudamericana 2026?</h2>
      <p>
        O bolão da Sudamericana 2026 é uma disputa entre amigos em que cada participante
        <strong>palpita os placares dos jogos</strong> da CONMEBOL Sudamericana e ganha pontos pela
        precisão dos acertos. No Cravei, você monta um bolão privado, convida a turma e acompanha
        quem está cravando mais — com o ranking atualizando ao vivo a cada gol do mata-mata, dos
        playoffs até a grande final.
      </p>
    </section>
    ...
    <section class="sec">
      <h2>Por que fazer seu bolão da Sudamericana no Cravei</h2>
      <ul class="reasons">
    ...
    <section class="sec band">
      ...
      <div class="band-in">
        <h2>Como criar ou entrar num bolão da Sudamericana</h2>
        <p>
          ...
          <NuxtLink to="/futebol/campeonato/sudamericana/jogos">jogos da Sudamericana 2026</NuxtLink>,
          ver a <NuxtLink to="/futebol/campeonato/sudamericana/tabela">chave do mata-mata</NuxtLink>,
