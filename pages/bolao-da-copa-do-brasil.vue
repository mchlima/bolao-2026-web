...
// Landing de SEO+GEO mirando "bolão da copa do brasil" (+ variações). A edição 2026
// está no mata-mata (oitavas em diante), então o foco é o bolão do mata-mata.
// Pública (ver guard.global.ts). Dados já no banco (seed-copa-do-brasil).
definePageMeta({ layout: 'default' });

const auth = useAuthStore();
const siteUrl = String(useRuntimeConfig().public.siteUrl);
const url = `${siteUrl}/bolao-da-copa-do-brasil`;
const authLink = useAuthLink();

const title = 'Bolão da Copa do Brasil 2026 grátis — palpite no mata-mata | Cravei';
const desc =
  'Faça seu bolão da Copa do Brasil 2026 grátis com os amigos: palpite nos jogos do mata-mata — oitavas, quartas, semis e final em ida e volta — pontue pela precisão do placar e acompanhe o ranking ao vivo a cada gol. Sem instalar app.';

// FAQ específico da Copa do Brasil (texto visível + FAQPage schema). Respostas curtas
// e autocontidas — formato que tanto o Google quanto as IAs citam (GEO).
const FAQ: FaqQA[] = [
  {
    q: 'O que é o bolão da Copa do Brasil 2026?',
    a: 'O bolão da Copa do Brasil 2026 é uma disputa entre amigos em que cada um palpita os placares dos jogos da Copa do Brasil e ganha pontos pela precisão dos acertos. No Cravei você cria um bolão privado grátis, convida a turma e vê o ranking se mexer ao vivo a cada gol do mata-mata.',
  },
  {
    q: 'O bolão da Copa do Brasil é grátis?',
    a: 'Sim. Criar conta, montar bolões e palpitar nos jogos da Copa do Brasil é totalmente grátis no Cravei, direto no navegador e sem precisar instalar aplicativo.',
  },
  {
    q: 'Quando começa o mata-mata da Copa do Brasil 2026?',
    a: 'As oitavas de final são em agosto de 2026, em jogos de ida e volta, e o mata-mata segue com quartas, semifinais e a final, também em ida e volta. No Cravei você já pode montar o bolão e cravar os placares de cada confronto.',
  },
  {
    q: 'Como criar um bolão da Copa do Brasil com os amigos?',
    a: 'Crie sua conta grátis, monte um bolão privado da Copa do Brasil e compartilhe o link de convite com a galera. Cada pessoa entra, palpita os jogos do mata-mata e disputa o ranking.',
  },
  {
  ...
  meta: [
    {
      name: 'keywords',
      content:
        'bolão da copa do brasil, bolão copa do brasil 2026, palpites da copa do brasil, bolão do mata-mata, bolão da copa do brasil grátis, bolão online grátis, bolão entre amigos, ranking ao vivo, bolão de futebol',
    },
  ],
  script: [
    { key: 'ld-faq', type: 'application/ld+json', innerHTML: JSON.stringify(faqJsonLd(FAQ)) },
    {
      ...
      innerHTML: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Bolão da Copa do Brasil 2026', item: url },
        ],
      }),
    },
  ],
...
// Faixa de números da Copa do Brasil 2026 (mata-mata) — chamativo + fatos (sinal GEO).
const stats = [
...
const steps = [
  { n: 1, t: 'Crie seu bolão', d: 'Faça sua conta grátis e monte um bolão privado da Copa do Brasil 2026 em menos de um minuto.', c: 'var(--emerald)' },
...
const reasons = [
  ...
  { i: 'refresh', c: 'var(--azure)', t: 'Placar automático', d: 'Os resultados dos jogos da Copa do Brasil entram sozinhos — você só palpita.' },
...
<template>
  <main class="lp container">
    <nav class="crumbs">
      ...
      <span>›</span>
      <span>Bolão da Copa do Brasil 2026</span>
    </nav>
    ...
    <header class="hero">
      ...
      <div class="hero-grid">
        <div class="hero-text">
          <span class="eyebrow"><span class="eb-dot" />Copa do Brasil · Mata-mata 2026</span>
          <h1>Bolão da <span class="hl">Copa do Brasil 2026</span></h1>
          <p class="lead">
            Crie seu <strong>bolão da Copa do Brasil 2026</strong> grátis e dispute com os amigos:
            palpite nos jogos do <strong>mata-mata</strong> — oitavas, quartas, semis e a final, em
            ida e volta —, pontue pela precisão do placar e veja o ranking se mexer <b>ao vivo</b> a
    ...
    <section class="sec intro">
      <h2>O que é o bolão da Copa do Brasil 2026?</h2>
      <p>
        O bolão da Copa do Brasil 2026 é uma disputa entre amigos em que cada participante
        <strong>palpita os placares dos jogos</strong> da Copa do Brasil e ganha pontos pela
    ...
    <section class="sec">
      <h2>Por que fazer seu bolão da Copa do Brasil no Cravei</h2>
      <ul class="reasons">
    ...
    <section class="sec band">
      ...
      <div class="band-in">
        <h2>Como criar ou entrar num bolão da Copa do Brasil</h2>
        <p>
          ...
          <NuxtLink to="/futebol/campeonato/copa-do-brasil/jogos">jogos da Copa do Brasil 2026</NuxtLink>,
          ver a <NuxtLink to="/futebol/campeonato/copa-do-brasil/tabela">chave do mata-mata</NuxtLink>,
