...
// Landing de SEO+GEO mirando "bolão do brasileirão" e "bolão do campeonato
// brasileiro" (+ variações). Página de conteúdo de verdade (a home é app-like):
// dá ao Google o conteúdo rico e, ao GEO, frases autocontidas + Q&A copiáveis que
// as IAs citam. Pública (ver guard.global.ts). Dados do Brasileirão já no banco.
definePageMeta({ layout: 'default' });

const auth = useAuthStore();
const siteUrl = String(useRuntimeConfig().public.siteUrl);
const url = `${siteUrl}/bolao-do-brasileirao`;
const authLink = useAuthLink();

const title = 'Bolão do Brasileirão 2026 grátis — Série A com os amigos | Cravei';
const desc =
  'Faça seu bolão do Brasileirão 2026 grátis com os amigos: palpite nos 380 jogos da Série A do Campeonato Brasileiro, pontue pela precisão do placar e acompanhe o ranking ao vivo a cada gol. Sem instalar app.';

// FAQ específico do Brasileirão (texto visível + FAQPage schema). Respostas curtas
// e autocontidas — formato que tanto o Google quanto as IAs citam (GEO).
const FAQ: FaqQA[] = [
  {
    q: 'O que é o bolão do Brasileirão 2026?',
    a: 'O bolão do Brasileirão 2026 é uma disputa entre amigos em que cada um palpita os placares dos jogos da Série A do Campeonato Brasileiro e ganha pontos pela precisão dos acertos. No Cravei você cria um bolão privado grátis, convida a turma e vê o ranking se mexer ao vivo a cada gol.',
  },
  {
    q: 'O bolão do Brasileirão é grátis?',
    a: 'Sim. Criar conta, montar bolões e palpitar nas 38 rodadas (380 jogos) do Brasileirão Série A é totalmente grátis no Cravei, direto no navegador e sem precisar instalar aplicativo.',
  },
  {
    q: 'Como criar um bolão do Campeonato Brasileiro com os amigos?',
    a: 'Crie sua conta grátis, monte um bolão privado do Brasileirão e compartilhe o link de convite com a galera. Cada pessoa entra, palpita os jogos da rodada e disputa o ranking da temporada.',
  },
  {
    q: 'Como funciona a pontuação do bolão do Brasileirão?',
  ...
  {
    q: 'Dá pra fazer bolão de todas as rodadas do Brasileirão?',
    a: 'Sim. O bolão vale para as 38 rodadas da Série A, do começo ao fim da temporada. Você palpita rodada a rodada e acumula pontos no ranking ao longo do campeonato.',
  },
  {
  ...
  meta: [
    {
      name: 'keywords',
      content:
        'bolão do brasileirão, bolão do campeonato brasileiro, bolão brasileirão 2026, bolão série a, palpites do brasileirão, bolão online grátis, bolão entre amigos, ranking ao vivo, bolão de futebol',
    },
  ],
  script: [
    { key: 'ld-faq', type: 'application/ld+json', innerHTML: JSON.stringify(faqJsonLd(FAQ)) },
    {
      ...
      innerHTML: JSON.stringify({
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Bolão do Brasileirão 2026', item: url },
        ],
      }),
    },
  ],
...
// Faixa de números do Brasileirão Série A 2026 — chamativo + fatos (sinal GEO).
const stats = [
  { n: '380', l: 'jogos pra palpitar' },
  { n: '20', l: 'clubes na Série A' },
  { n: 'R$ 0', l: 'pra jogar, sempre' },
];

const steps = [
  { n: 1, t: 'Crie seu bolão', d: 'Faça sua conta grátis e monte um bolão privado do Brasileirão 2026 em menos de um minuto.', c: 'var(--emerald)' },
...
const reasons = [
  { i: 'live', c: 'var(--scarlet)', t: 'Ranking ao vivo', d: 'A classificação do seu bolão atualiza a cada gol da rodada, em tempo real.' },
  { i: 'refresh', c: 'var(--azure)', t: 'Placar automático', d: 'Os resultados dos 380 jogos entram sozinhos — você só palpita.' },
...
<template>
  <main class="lp container">
    <nav class="crumbs">
      ...
      <span>›</span>
      <span>Bolão do Brasileirão 2026</span>
    </nav>
    ...
    <header class="hero">
      ...
      <div class="hero-grid">
        <div class="hero-text">
          <span class="eyebrow"><span class="eb-dot" />Brasileirão Série A · 2026</span>
          <h1>Bolão do <span class="hl">Brasileirão 2026</span></h1>
          <p class="lead">
            Crie seu <strong>bolão do Brasileirão 2026</strong> grátis e dispute com os amigos:
            palpite nos 380 jogos da Série A do <strong>Campeonato Brasileiro</strong>, pontue pela
            precisão do placar e veja o ranking se mexer <b>ao vivo</b> a cada gol. Sem instalar app,
            direto no navegador.
          </p>
          <div class="cta">
        ...
        <div class="hero-art" aria-hidden="true">
          <div class="card mock live">
            <div class="mock-top">
              <span class="mlbl">Rodada 12 · 2º tempo</span>
              <span class="mstatus"><span class="d" />Ao vivo</span>
            </div>
            <div class="mock-row">
              <div class="mteam"><b>FLA</b></div>
    ...
    <section class="sec intro">
      <h2>O que é o bolão do Brasileirão 2026?</h2>
      <p>
        O bolão do Brasileirão 2026 é uma disputa entre amigos em que cada participante
        <strong>palpita os placares dos jogos</strong> da Série A do Campeonato Brasileiro e ganha
        ...
        do começo ao fim das 38 rodadas.
      </p>
    </section>
    ...
    <section class="sec">
      <h2>Por que fazer seu bolão do Brasileirão no Cravei</h2>
      <ul class="reasons">
    ...
    <section class="sec band">
      ...
      <div class="band-in">
        <h2>Como criar ou entrar num bolão do Campeonato Brasileiro</h2>
        <p>
          ...
          <NuxtLink to="/futebol/campeonato/brasileirao-serie-a/jogos">agenda dos jogos do Brasileirão</NuxtLink>,
          ver a <NuxtLink to="/futebol/campeonato/brasileirao-serie-a/tabela">tabela da Série A</NuxtLink>,
