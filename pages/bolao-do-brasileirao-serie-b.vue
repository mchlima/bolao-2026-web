...
const FAQ: FaqQA[] = [
  ...
  {
    q: 'Quantos times sobem da Série B para a Série A?',
    a: 'Os quatro primeiros colocados da Série B conquistam o acesso à Série A do Brasileirão na temporada seguinte. No bolão você acompanha rodada a rodada a briga pelo acesso e contra o rebaixamento.',
  },
  {
...
const reasons = [
  ...
  { i: 'refresh', c: 'var(--azure)', t: 'Placar automático', d: 'Os resultados dos 380 jogos da Série B entram sozinhos — você só palpita.' },
  ...
  { i: 'list', c: 'var(--magenta)', t: 'Briga pelo acesso', d: 'Acompanhe rodada a rodada quem sobe pra Série A e quem foge do rebaixamento.' },
      ...
      <div class="hero-grid">
        ...
        <div class="hero-art" aria-hidden="true">
          <div class="card mock live">
            <div class="mock-top">
              <span class="mlbl">Rodada 14 · 2º tempo</span>
              <span class="mstatus"><span class="d" />Ao vivo</span>
            </div>
            <div class="mock-row">
              <div class="mteam"><b>GOI</b></div>
              <div class="font-numeric mscore">2<span>:</span>1</div>
              <div class="mteam"><b>CEA</b></div>
            </div>
            <div class="mock-foot">
    ...
    <section class="sec band">
      ...
      <div class="band-in">
        ...
        <p>
          ...
          <NuxtLink to="/futebol/campeonato/brasileirao-serie-b/jogos">agenda dos jogos da Série B</NuxtLink>,
          ver a <NuxtLink to="/futebol/campeonato/brasileirao-serie-b/tabela">tabela da Série B</NuxtLink>,
